...
return GenericObject::f(
  ...
  GenericObject::f('a', ['long string that should be broken down', 'another long string which follows the previous string which came before it'], 'last line text which is too long'),
...
return GenericObject::f(
  ...
  GenericObject::f('a', [
    'long string that should be broken down',
    'another long string which follows the previous string which came before it',
  ], 'last line text which is too long'),
  GenericObject::f(
    'first line text which is too long for it all to be inline',
