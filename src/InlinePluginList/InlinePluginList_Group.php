...
abstract class InlinePluginList_Group implements InlinePluginListInterface {
   ...
   */
  public static function fromGroup(Formula_GroupInterface $formula, IncarnatorInterface $formulaToAnything): ?InlinePluginListInterface {
   ...
   * @throws \Donquixote\Ock\Exception\IncarnatorException
   */
  public static function fromGroupVal(Formula_GroupValInterface $formula, IncarnatorInterface $formulaToAnything): ?InlinePluginListInterface {
   ...
   * @throws \Donquixote\Ock\Exception\IncarnatorException
   */
  public static function create(Formula_GroupInterface $groupFormula, V2V_GroupInterface $v2v, IncarnatorInterface $formulaToAnything): ?InlinePluginListInterface {
