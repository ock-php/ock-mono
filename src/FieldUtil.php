...
abstract class FieldUtil {
   ...
   *   Format: $[$fieldName] = $optionLabel
   */
  static function fieldTypesGetFieldNameOptions(array $fieldTypes = NULL, $entityType = NULL, $bundleName = NULL) {
    ...
    foreach ($optionsAll as $fieldName => $optionLabel) {
      if (isset($fields[$fieldName]['type']) && in_array($fields[$fieldName]['type'], $fieldTypes)) {
